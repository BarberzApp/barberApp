-- Fix reels migration by properly handling existing tables and policies
...
-- Create reels analytics table if it doesn't exist
...
-- Function to update reel stats from analytics (IF NOT EXISTS)
...
DROP TRIGGER IF EXISTS trigger_update_reel_stats ON reel_analytics;
