...
DROP POLICY IF EXISTS "Enable all for authenticator" ON bookings;
...
-- Allow the authenticator role to bypass RLS
...
-- Ensure the authenticator role has the necessary permissions
ALTER POLICY "authenticator_bypass" ON bookings TO authenticator; 